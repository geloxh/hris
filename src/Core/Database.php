...
/**
 * Thin PDO wrapper. Single connection per request (PHP-FPM process),
 * always uses prepared statements so every module gets injection safety for free.
 */
class Database
{
    ...
    /**
     * Runs $callback inside a transaction, rolling back automatically on exception.
     */

...
$router->delete('/api/employees/{id}', [EmployeeController::class, 'destroy'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr'])]);
$router->post('/api/employees/{id}/terminate', [EmployeeController::class, 'terminate'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr'])]);
...
$router->post('/api/departments', [DepartmentController::class, 'store'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr'])]);
$router->put('/api/departments/{id}', [DepartmentController::class, 'update'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr'])]);
$router->delete('/api/departments/{id}', [DepartmentController::class, 'destroy'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr'])]);

$router->get('/api/positions', [PositionController::class, 'index'], [AuthMiddleware::class]);
$router->post('/api/positions', [PositionController::class, 'store'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr'])]);
$router->put('/api/positions/{id}', [PositionController::class, 'update'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr'])]);
$router->delete('/api/positions/{id}', [PositionController::class, 'destroy'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr'])]);
...
$router->post('/api/attendance/manual', [AttendanceController::class, 'storeManual'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr', 'manager'])]);
...
$router->get('/api/leave/requests/pending', [LeaveController::class, 'pending'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr', 'manager'])]);
$router->post('/api/leave/requests', [LeaveController::class, 'store'], [AuthMiddleware::class]);
$router->post('/api/leave/requests/{id}/approve', [LeaveController::class, 'approve'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr', 'manager'])]);
$router->post('/api/leave/requests/{id}/reject', [LeaveController::class, 'reject'],
    [AuthMiddleware::class, RoleMiddleware::only(['admin', 'hr', 'manager'])]);
